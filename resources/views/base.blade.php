...
<html>
<head>
    <title>Music-leaks</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    <link href="https://fonts.googleapis.com/css?family=Arvo|Titillium+Web" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="style.css" />
    {{ Html::style('css/style.css') }}
</head>
<body>
<div class="logo">
    <img src="https://s13.postimg.org/lllk80dx3/image.png" alt="music-tracker-logo" id="music-tracker-logo">
</div>
